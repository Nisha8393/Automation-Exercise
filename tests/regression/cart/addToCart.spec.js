...
test.describe("Add to Cart", { tag: "@regression" }, () => {
  ...
  test(
    "Add product from product detail page - Product appears in cart",
    { tag: "@R-CART-02" },
    async ({
      header,
      productsPage,
  ...
  test(
    "Add product from homepage - Product appears in cart",
    { tag: ["@R-CART-03", "@S-CP-01"] },
  ...
  test(
    "Add product from recommended items - Product appears in cart",
    { tag: "@R-CART-04" },
    async ({ home, viewCartPage, isolatedPage }) => {
  ...
  test(
    "Add multiple different products - Both appear in cart",
    { tag: "@R-CART-07" },
    async ({ home, viewCartPage, isolatedPage }) => {
      // Add first product
      await home.addProductToCart(PRODUCT_A);
  ...
  test(
    "Add same product twice - Quantity shows 2",
    { tag: "@R-CART-08" },
    async ({ home, viewCartPage, isolatedPage }) => {
