...
test.describe("Unhappy Path - Network Failures", { tag: "@regression" }, () => {
  test("Add to cart with a 500 response - nothing is added and no modal appears", async ({
    isolatedPage,
    home,
    header,
    viewCartPage,
  ...
  test("Add to cart with the request aborted - nothing is added and no modal appears", async ({
    isolatedPage,
    home,
    header,
    viewCartPage,
  ...
  test("Add to cart over a slow connection - the modal still appears once it responds", async ({
    isolatedPage,
    home,
  }) => {
  ...
  test("Remove from cart with a 500 response - the item stays in the cart", async ({
    isolatedPage,
    home,
    header,
    viewCartPage,
