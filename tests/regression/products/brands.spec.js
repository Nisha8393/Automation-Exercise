...
test.describe("Brand Filtering", { tag: "@regression" }, () => {
  ...
  test(
    "Filter by Polo brand - Shows Polo products",
    { tag: ["@R-PROD-17", "@R-PROD-22"] },
  ...
  test(
    "Filter by H&M brand - Shows H&M products",
    { tag: "@R-PROD-18" },
    async ({ sidebar, productsPage, isolatedPage }) => {
  ...
  test(
    "Filter by Madame brand - Shows Madame products",
    { tag: "@R-PROD-19" },
    async ({ sidebar, productsPage, isolatedPage }) => {
  ...
  test(
    "Filter by Babyhug brand - Shows Babyhug products",
    { tag: "@R-PROD-20" },
    async ({ sidebar, productsPage, isolatedPage }) => {
  ...
  test(
    "Filtered product belongs to the brand - Detail page confirms",
    { tag: "@R-PROD-27" },
    async ({ sidebar, productsPage, productDetailsPage, isolatedPage }) => {
      await sidebar.clickBrand("Polo");
  ...
  test(
    "Switch between brands - Heading updates correctly",
    { tag: "@R-PROD-21" },
    async ({ sidebar, productsPage, isolatedPage }) => {
      // First: select Polo
